...
import { Card, Typography, Button, Tag, Divider, QRCode, Space, Timeline, Avatar } from "antd";
import {
...
interface VaccinePassportTabProps {
  userName?: string;
  userId?: string;
}

const VaccinePassportTab: React.FC<VaccinePassportTabProps> = ({
  ...
  const passportData = {
    qrValue: `VACCINE_PASSPORT:${userId}:${Date.now()}`,
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <Paragraph className="mb-0 text-sm">
              View your complete vaccination history and transaction details on the
              SafeVax Blockchain Explorer
            </Paragraph>
          </div>
          <Button
            type="primary"
