          ...
          <div className="text-white">
            ...
            <div className="space-x-4">
              <Button type="primary"  className="bg-white text-blue-600">
                <Link href="/market">{t('hero.viewVaccines')}</Link>
              </Button>
              <Button  ghost>
            ...
            <div className="relative max-w-md w-full ml-auto">
              <div className="bg-white p-6 rounded-xl shadow-xl border border-gray-100">
                <div className="flex justify-between items-center mb-4">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">{t('hero.certificate.title')}</h3>
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-xl shadow-lg border border-gray-100 w-32">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-xs font-medium text-center">{t('hero.certificate.verification')}</p>
                </div>
              </div>
